...
/* ── Toast notifications (FIXED: cap at 5, clear timers on eviction) ───────── */
...
// Cap: remove oldest excess toasts, clearing their timers
while (container.children.length >= MAX_TOASTS) {
  const oldest = container.firstElementChild;
  if (oldest && oldest._clearToast) oldest._clearToast();
